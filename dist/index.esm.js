...
function CompactKeyboard({
  ...
  const updatePredictions = useCallback((currentText) => {
    if (!showPredictions) {
      setPredictions([]);
      return;
    }
  ...
  const handleMultiTapKey = useCallback((key) => {
  ...
  const handleKeyPress = useCallback((key, event) => {
    if (onKeyPress)
  ...
  const handlePredictionSelect = useCallback((pred) => {
  ...
  const renderKey = useCallback((key, idx) => {
    ...
    return /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: inputMode === "compact" && key.secondary ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("span", { className: "ckb-key-primary", children: composition && key.secondary.includes(composition) ? composition : key.primary[0] }),
          /* @__PURE__ */ jsx("span", { className: "ckb-key-secondary", children: key.primary })
        ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          key.primary,
          key.secondary && key.secondary.length > 1 && inputMode === "t9" && /* @__PURE__ */ jsx("span", { className: "ckb-key-multitap", children: composition && key.secondary.includes(composition) ? composition : "" })
        ] })
      },
      `k-${idx}`
    );
  }, [activeKeyIdx, inputMode, composition, handleKeyPress, keyBorderRadius]);
  const renderSwipeMode = () => /* @__PURE__ */ jsx(
    "div",
    {
      className: "ckb-body",
      style: {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "ckb-row", style: { flexWrap: "wrap", padding: "2px" }, children: [
        SWIPE_DIRECTIONS.map((d, i) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { style: { fontSize: "14px" }, children: d.dir }),
              /* @__PURE__ */ jsx("span", { style: { fontSize: "7px", opacity: 0.5 }, children: d.letters })
            ]
          },
          i
        )),
  ...
  const renderCompactMode = () => /* @__PURE__ */ jsx(
    "div",
    {
      className: "ckb-body",
      style: {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "ckb-row-single", children: COMPACT_ROW.map((key, idx) => renderKey(key, idx)) })
    }
  );
  const renderT9Mode = () => /* @__PURE__ */ jsx(
    "div",
    {
      className: "ckb-body",
      style: {
      ...
      children: T9_LAYOUT.map((row, ri) => /* @__PURE__ */ jsx("div", { className: "ckb-row", children: row.map((key, idx) => renderKey(key, ri * 4 + idx)) }, `r-${ri}`))
    }
  );
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        showPredictions && predictions.length > 0 && /* @__PURE__ */ jsx("div", { className: "ckb-predictions", children: predictions.map((pred, i) => /* @__PURE__ */ jsx(
          "button",
          {
...
function useCompactKeyboard(initialConfig = {}) {
  const configRef = useRef2({ ...DEFAULT_CONFIG, ...initialConfig });
  ...
  const updatePredictions = useCallback2((text) => {
  ...
  const insertText = useCallback2((text) => {
    setState((prev) => {
  ...
  const deleteBackward = useCallback2((count = 1) => {
    setState((prev) => {
      const pos = prev.caretPosition;
  ...
  const setConfig = useCallback2((patch) => {
